...
document.addEventListener('DOMContentLoaded', function () {
    ...
    var header = document.querySelector('#modx-panel-holder');
    ...
    function getDuplicates() {
        ...
        bodyPanel.innerHTML = 'Собираю клюбнику...';
    ...
    function renderPanelActions() {
        ...
        let p_form = `<form id="form_panel_form" class="ms-auto form_panel_form" method="get" action="${connector}">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-3">
                    <button id="form_panel_form_submit" type="submit" class="btn btn-primary pull-right">OK</button>
                  </div>
                </div>
            </form>`;
        ...
        formElem.addEventListener("submit", function (e) {
            ...
            let buttonSubmit = document.getElementById('form_panel_form_submit');
            ...
            if (listChecked.length) {
                ...
                bodyPanel.innerHTML = '<div class="alert alert-info">Обработка дубликатов, ждите...</div>';
                ...
                buttonSubmit.removeAttribute('disabled');
                //bodyPanel.innerHTML = '<div class="alert alert-warning">Нечего обрабатывать!</div>';
            }
